...
const About = () => {
  return (
    <>
      <section
        id="second_section"
        className="w-full h-auto font-title overflow-hidden relative flex flex-col justify-between pb-14 2xl:min-h-screen xl:pt-10 xl:pb-20  2xl:pb-24  bg-zinc-800"
      >
