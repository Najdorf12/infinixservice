...
const Home = () => {
  return (
    <>
      ...
      >
        <nav className="bg-gradient-to-tr mx-auto self-center from-primary via-zinc-800 to-zinc-900 w-full absolute top-0 shadow-md shadow-white flex justify-evenly py-2 font-title2 text-base text-white rounded-b-full md:w-[90%] xl:text-lg 2xl:text-xl z-50 2xl:py-3">
