...
const Home = () => {
  return (
    <>
      ...
      >
        <nav className="bg-gradient-to-tr mx-auto self-center from-primary via-zinc-800 to-zinc-900 w-full absolute top-0 shadow-md shadow-white flex justify-evenly py-2 font-title2 text-base text-white rounded-b-full md:w-[80%] xl:text-lg 2xl:text-xl z-50 2xl:py-3">
        ...
        <section className="pb-0 md:pb-3  lg:h-full  lg:flex z-50 lg:self-start lg:w-[60%] xl:w-1/2">
          ...
          <figure className=" absolute -bottom-[2px] left-o rounded-tr-2xl lg:bottom-0 pt-2 pl-3 pr-2 pb-1 lg:pb-3 lg:w-[30%] 2xl:[25%] bg-zinc-900 z-50">
            <div className="flex justify-center items-center w-full h-full gap-3 2xl:gap-4 ">
              ...
              <button className="button">
                <a href="https://www.grupolacomunidad.com.ar/products/infinix" target="_blank">
