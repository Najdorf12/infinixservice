  ...
  return (
    <>
      ...
      >
        ...
        <article
          id="box-glass"
          className="flex flex-col items-start py-6 px-3 mt-14 z-50 w-full  border-zinc-100 border-t-[2px] border-b-[2px]   rounded-2xl max-w-[500px] sm:px-4 xl:max-w-[650px] text-balance  2xl:max-w-[800px] xl:px-6 xl:py-8 2xl:py-10 xl:mt-8 2xl:mt-14"
        >
